...
TEST(VehicleSpeedMonitorTestSuite, MonitorInteractWithLoggerWhenThresholdNotInRange)
{
    ...
    string  expectedMsgToBeRecvdByLoggerWrite="_speedThreshold value must be in the ramge {1-100} 150";
    EXPECT_STREQ(writeMethodArg,expectedMsgToBeRecvdByLoggerWrite);
}
